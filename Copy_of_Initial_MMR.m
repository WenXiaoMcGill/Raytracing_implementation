...
f = [125 250 500 1000 2000 4000 8000]/20000;
concrete = [0.01 0.01 0.02 0.02 0.02 0.05 0.05];
wood = [0.09 0.06 0.05 0.05 0.05 0.04 0.04];
lime = [0.02 0.03 0.04 0.05 0.04 0.03 0.02];

f_concrete = Wall_Filter(f, concrete, DispFilter);
f_wood = Wall_Filter(f, wood, DispFilter);
f_lime = Wall_Filter(f, lime, DispFilter);
